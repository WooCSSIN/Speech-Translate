    ...
    def __create_tray(self):
        ...
        try:
            self.menu_items = (
                ...
                pystray.Menu.SEPARATOR,
                pystray.MenuItem(
                    "Visit Repository", lambda *args: open_url("https://github.com/WooCSSIN/Speech-Translate")
                ),
                pystray.MenuItem(
                    "Read Wiki", lambda *args: open_url("https://github.com/WooCSSIN/Speech-Translate/wiki")
                ),
...
class MainWindow:
    ...
    def __init__(self):
        ...
        self.fm_help.add_command(
            ...
            command=lambda: open_url("https://github.com/WooCSSIN/Speech-Translate/wiki")
        )
        self.fm_help.add_command(
            label="Visit Repository", command=lambda: open_url("https://github.com/WooCSSIN/Speech-Translate")
        )
    ...
    def __on_init(self):
        ...
        def first_open():
            if mbox(
                ...
                open_url("https://github.com/WooCSSIN/Speech-Translate/wiki")
    ...
    def rec(self):
        ...
        assert model_tc is not None, (
            ...
            "Report this as a bug at https://github.com/WooCSSIN/Speech-Translate/issues"
        )
