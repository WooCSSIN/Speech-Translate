...
class AboutWindow:
    ...
    def open_dl_link(self, _event=None):
        open_url("https://github.com/WooCSSIN/Speech-Translate/releases/latest")
    ...
    def req_update_check(self, notify_up_to_date=False):
        ...
        try:
            ...
            req = get("https://api.github.com/repos/WooCSSIN/Speech-Translate/releases/latest", timeout=7)
